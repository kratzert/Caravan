...
The Caravan dataset that was released together with the [paper](https://eartharxiv.org/repository/view/3345/) can be found [here](https://doi.org/10.5281/zenodo.6522635).
...
Additionally, we would highly appreciated if you also cite the corresponding manuscripts of the source datasets. For details on the references, see the information included in the licenses folder of the [Caravan dataset](https://doi.org/10.5281/zenodo.6522635)
